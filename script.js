      ...
      marker.bindPopup(`
        <div class="popup-content">
          ...
          <a href="https://www.google.com/maps/dir/?api=1&destination=${lat},${lng}"
             target="_blank" rel="noopener" class="popup-btn-maps">
...
function tampilkanDetail(index) {
  ...
  document.getElementById("detailLokasi").innerHTML = `
    ...
    <a href="https://www.google.com/maps/dir/?api=1&destination=${lat},${lng}"
       target="_blank" rel="noopener" class="btn-arah-maps">
      📍 Buka Arah di Google Maps
    </a>
...
// =============================
// GESER (SWIPE) UNTUK GANTI FOTO DI HP
// =============================
// Memungkinkan pengunjung menggeser jari ke kiri/kanan di atas foto
// untuk pindah slide, selain lewat tombol panah atau titik.
...
(function () {
  ...
  document.addEventListener("touchstart", function (e) {
    var track = e.target.closest(".slide-track");
    if (!track) return;
  ...
  document.addEventListener("touchend", function (e) {
    ...
    var selisih = endX - startX;
    var batasMinimal = 40; // jarak geser minimal (px) supaya tidak salah pencet

    if (Math.abs(selisih) < batasMinimal) return;

    if (selisih < 0) {
      gantiSlide(1); // geser ke kiri = foto berikutnya
    } else {
      gantiSlide(-1); // geser ke kanan = foto sebelumnya
    }
  }, { passive: true });
})();
